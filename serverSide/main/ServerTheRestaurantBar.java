...
public class ServerTheRestaurantBar
{
  /**
   ...
   */
   ...
   {
      Bar varBar;                                              // barber shop (service to be rendered)
      BarInterface varBarInter;                                // interface to the barber shop
     ...
     /* service is established */
      ...
      varBar = new Bar (reposStub);                                      // service is instantiated
      varBarInter = new BarInterface (varBar);                            // interface to the service is instantiated
     ...
     /* service request processing */
      ...
      { try
        { sconi = scon.accept ();                                    // enter listening procedure
          cliProxy = new BarClientProxy (sconi, varBarInter);    // start a service provider agent to address
