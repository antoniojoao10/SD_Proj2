...
public class ServerTheRestaurantKitchen
{
  /**
   ...
   */
   ...
   {
      Kitchen varKitchen;                                              // Kitchenber shop (service to be rendered)
      KitchenInterface varKitchenInter;                                // interface to the Kitchenber shop
     ...
     /* service is established */
      ...
      varKitchen = new Kitchen (reposStub);                                      // service is instantiated
      varKitchenInter = new KitchenInterface (varKitchen);                            // interface to the service is instantiated
     ...
     /* service request processing */
      ...
      { try
        { sconi = scon.accept ();                                    // enter listening procedure
          cliProxy = new KitchenClientProxy (sconi, varKitchenInter);    // start a service provider agent to address
