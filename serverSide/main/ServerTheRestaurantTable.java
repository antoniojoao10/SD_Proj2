...
public class ServerTheRestaurantTable
{
  /**
   ...
   */
   ...
   {
      Table varTable;                                              // Tableber shop (service to be rendered)
      TableInterface varTableInter;                                // interface to the Tableber shop
     ...
     /* service is established */
      ...
      varTable = new Table (reposStub);                                      // service is instantiated
      varTableInter = new TableInterface (varTable);                            // interface to the service is instantiated
     ...
     /* service request processing */
      ...
      { try
        { sconi = scon.accept ();                                    // enter listening procedure
          cliProxy = new TableClientProxy (sconi, varTableInter);    // start a service provider agent to address
